...
test.describe("Steam Store - Top Sellers Discount", () => {
    test("should find the game with the highest discount in Action Top Sellers and verify its details", async ({
        homePage,
        actionPage,
        ageCheckPage,
        detailsPage,
        ...
        let detailName, detailOriginalPrice, detailDiscountedPrice, detailDiscountPct;
